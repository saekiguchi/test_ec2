...
namespace Symfony\Config\Eccube\RateLimiter;
...
class LimitersConfig 
{
     ...
     * @return $this
     */
    public function type(ParamConfigurator|string|array $value): static
    {
     ...
     * @return $this
     */
    public function method(ParamConfigurator|string|array $value): static
    {
